...
const imageInputGalery = popupElementGalery.querySelector(".popup__input_type_image")
...
popupButtonOpenElementProfile.addEventListener('click', () => popupOpen(popupElementProfile))
